...
sudo dd bs=1M if=/dev/sdd1 if=/dev/sdd2 of=yunohost-cubieboard-a20-2014-10-11.img

### Try image
# Copy image to sd card
sudo dd bs=1M if=yunohost-cubieboard-a20-2014-10-11.img of=/dev/sdd1 of=/dev/sdd2
...
zip yunohost-cubieboard-a20-2014-10-11.img.zip yunohost-cubieboard-a20-2014-10-11.img
